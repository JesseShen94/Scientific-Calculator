...
public class CalculateTest {
    ...
    final String[] threeNotation=new String[]{"_E_+5+_pi_-6+_sin_50","_Ne_432_/__(__E__+__pi__)_" };
    ...
    public void getResult() {
        ...
        assertTrue("Cannot get correct resulf of "+oneNotation[0],Calculate.getResult(oneNotation[0]).equals(String.valueOf((double)5)));
        assertTrue("Cannot get correct resulf of "+oneNotation[1],Calculate.getResult(oneNotation[1]).equals(String.valueOf((double)(-6))));
        assertTrue("Cannot get correct resulf of "+oneNotation[2],Calculate.getResult(oneNotation[2]).equals(String.valueOf(Math.sin(Math.toRadians(50)))));
        assertTrue("Cannot get correct resulf of "+oneNotation[3],Calculate.getResult(oneNotation[3]).equals(String.valueOf(Math.cos(Math.toRadians(30)))));

        assertTrue("Cannot get correct resulf of "+oneNotation[4],Calculate.getResult(oneNotation[4]).equals(String.valueOf(Math.tan(Math.toRadians(45)))));

        assertTrue("Cannot get correct resulf of "+oneNotation[5],Calculate.getResult(oneNotation[5]).equals(String.valueOf(Math.log(7)/Math.log(Math.E))));
        assertTrue("Cannot get correct resulf of "+oneNotation[6],Calculate.getResult(oneNotation[6]).equals(String.valueOf(Math.log(9)/Math.log(10))));
        assertTrue("Cannot get correct resulf of "+oneNotation[7],Calculate.getResult(oneNotation[7]).equals(String.valueOf(Math.sqrt(121))));
        assertTrue("Cannot get correct resulf of "+oneNotation[8],Calculate.getResult(oneNotation[8]).equals(String.valueOf(Math.pow(7.4,9.8))));
        assertTrue("Cannot get correct resulf of "+oneNotation[9],Calculate.getResult(oneNotation[9]).equals(String.valueOf((double)(0-432))));
